<template>
    <section :class="{
        'my-64': previousSectionId && nextSectionId,
        'mt-24': previousSectionId
    }" class="flex flex-col">
        ...
        <!--Cards-->
        <ul class="list-none m-0 p-0 mt-10 grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">

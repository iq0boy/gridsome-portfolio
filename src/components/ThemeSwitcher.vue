<template>
    <a class="cursor-pointer" role="button" @click="toggleTheme()"
       :aria-label="'Toggle ' + nextTheme"
       :title="'Toggle ' + nextTheme"
    >
        <sunLogo class="mr-3" v-show="theme === 'dark'"></sunLogo>
        <moon-logo class="mr-3 moon" v-show="theme === 'light'"></moon-logo>
    </a>
</template>

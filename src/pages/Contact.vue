<template>
  <Layout :hideHeader="true">
    <div class="container mx-auto px-2 pt-24 pb-16 relative overflow-x-hidden">
      ...
      <form action="https://formspree.io/mlepbawr" method="POST" class="w-full">
        <fieldset class="mt-2">
          <label for="_replyto">Your email :</label>
          <input
            class="w-full mt-2 rounded border-gray-600"
            id="_replyto"
            type="email"
            name="_replyto"
          />
        ...
        <fieldset class="mt-4">
          <button
            class="border border-black py-2 px-4 cursor-pointer text-bold rounded font-medium text-center w-full"
            type="submit"
          >
            Submit
          </button>

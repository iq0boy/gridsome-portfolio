    ...
    <div class="container sm:pxi-0 mx-auto overflow-x-hidden pt-24 pb-12">
      ...
      <div class="px-4 pt-8">
        <section class="border-b">
          <div
            class="flex flex-col md:flex-row justify-between items-center md:items-start"
          >
            <h1
          ...
          <div
            class="text-2xl pt-4 pb-6 text-gray-700"
            v-html="$page.tech.shortDescription"
          ></div>
      ...
      <div class="px-4 sm:px-0 mt-10">
        ...
        <blockquote v-if="$page.tech.relatedProjects.edges.length">
          ...
          <ul>
            <li
              v-for="project in $page.tech.relatedProjects.edges"
              :key="project.node.id"
            >
